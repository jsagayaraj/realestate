 ...
 */
final class Version20190211132543 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE property ADD category_id INT DEFAULT NULL, CHANGE sold sold TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE property DROP category_id, CHANGE sold sold TINYINT(1) NOT NULL');
    }
}
