 ...
 */
final class Version20190212145928 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE property ADD category_id INT NOT NULL, CHANGE sold sold TINYINT(1) NOT NULL');
