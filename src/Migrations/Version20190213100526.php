 ...
 */
final class Version20190213100526 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE property ADD type_id INT NOT NULL, CHANGE sold sold TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE property DROP type_id, CHANGE sold sold TINYINT(1) NOT NULL');
    }
}
